# Toksido Suit — Premium Menswear Platform

A full-stack e-commerce and admin platform for a luxury suit atelier. Built with a modern Next.js frontend and a Node.js/Express REST API backend, supporting trilingual content (English, Amharic, Oromoo).
...
| **Zod**                       | Schema validation (shared with backend logic) |
| **next-intl**                 | Internationalization — EN / AM / OM           |
| **Axios**                     | HTTP client with interceptors & token refresh |
| **@react-three/fiber + drei** | 3D hero section using Three.js                |
| **SweetAlert2**               | Styled confirmation & error dialogs           |
| **js-cookie**                 | Cookie access for locale & auth token         |
