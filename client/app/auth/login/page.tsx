...
import { loginSchema } from "@/src/utils/libs/sanitize";
      ...
      <div className="max-w-5xl w-full flex flex-col md:flex-row bg-white shadow-[0_40px_100px_rgba(26,43,60,0.12)] relative overflow-hidden border border-[#1a2b3c]/5">
        ...
        <div className="md:w-1/2 p-8 md:p-20 bg-white flex flex-col justify-center relative">
          ...
          <form className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Button
              variant="ghost"
              className="group relative w-full bg-[#1a2b3c] text-[#f8f5f0] py-5 overflow-hidden transition-all shadow-xl cursor-pointer"
            >
              <span className="relative z-10 text-[11px] font-bold uppercase tracking-[0.4em]">
                {isSubmitting ? "go to toxido..." : "Login To Toxido"}
              </span>
          ...
          <div className="mt-16 pt-8 border-t border-[#f8f5f0] flex flex-col items-center">
            ...
            <Link
              href="/auth/register"
              className="text-[10px] uppercase tracking-[0.2em] font-black text-[#1a2b3c] hover:text-[#8e6d31] transition-all border-b border-[#8e6d31] pb-1 mb-8"
            >
              Create an Account
            </Link>
            ...
            <div className="flex flex-col items-center">
              <span className="text-[9px] uppercase tracking-[0.1em] text-[#5a6a7a] mb-3">
                Or explore via
              </span>
              ...
              >
                ...
                <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#1a2b3c]">
                  Login with Google
                </span>
              </Link>
            </div>
